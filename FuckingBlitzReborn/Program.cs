...
namespace FuckingBlitzReborn
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("FuckingBlitzReborn injected...");
        ...
        private static void BlitzOnLoad(EventArgs args)
        {
            ...
            // Load Menu
            _menu = new Menu("FuckingBlitzReborn", "FuckingBlitzReborn", true);
            ...
            _menu.AddItem(new MenuItem("grabkey", "Grab (active)")).SetValue(new KeyBind('A', KeyBindType.Press));
            ...
            Game.PrintChat("<b><font color=\"#FF00BF\">Fucking</font><font color=\"#FFFF00\">BlitzcrankReborn</font> <font color=\"#F5ECCE\">by</font> <font color=\"#FF0000\">folx</font> </b>");
